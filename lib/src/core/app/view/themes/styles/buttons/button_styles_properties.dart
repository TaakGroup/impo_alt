...
Color overlayColor(BuildContext context, ButtonColors buttonColor, Set<MaterialState> states) {
  switch (buttonColor) {
    case ButtonColors.primary:
      if (states.contains(MaterialState.hovered)) {
        return PrimaryPalette.of(context).primary50!.withOpacity(0.1);
      } else if (states.contains(MaterialState.focused)) {
        return PrimaryPalette.of(context).primary40!.withOpacity(0.1);
      } else if (states.contains(MaterialState.pressed)) {
        return PrimaryPalette.of(context).primary30!.withOpacity(0.1);
      } else if (states.contains(MaterialState.disabled)) {
        return NeutralPalette.of(context).neutral95!.withOpacity(0.1);
      } else {
...
Color textButtonForegroundColor(BuildContext context, ButtonColors buttonColor, Set<MaterialState> states) {
  switch (buttonColor) {
    case ButtonColors.primary:
      if (states.contains(MaterialState.hovered)) {
        return context.isDarkMode ? NeutralPalette.of(context).neutral95! : PrimaryPalette.of(context).primary50!;
      } else if (states.contains(MaterialState.focused)) {
        return context.isDarkMode ? NeutralPalette.of(context).neutral95! : PrimaryPalette.of(context).primary40!;
      } else if (states.contains(MaterialState.pressed)) {
        return context.isDarkMode ? NeutralPalette.of(context).neutral95! : PrimaryPalette.of(context).primary30!;
      } else if (states.contains(MaterialState.disabled)) {
