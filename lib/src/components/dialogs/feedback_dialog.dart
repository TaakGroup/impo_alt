...
class FeedBackDialog extends StatefulWidget{
  ...
  final fromActiveClini;
    ...
    FeedBackDialog({Key? key,this.scaleAnim,this.onPressClose,this.expertPresenter,this.chatId,this.fromMainExpert,this.fromActiveClini}):super(key:key);
                                        ...
                                        children: <Widget>[
                                          ...
                                          Container(
                                              ...
                                              child: Theme(
                                                ...
                                                child:  TextField(
                                                  controller: widget.expertPresenter!.rateValueController,
                                                  maxLines: 3,
                                                  maxLength: 250,
                                            ...
                                            builder: (context,snapshotIsLoadingButton){
                                              if(snapshotIsLoadingButton.data != null){
                                                return  CustomButton(
                                                  title: 'ارسال بازخورد',
                                                  onPress: (){
                                                    widget.expertPresenter!.sendRequestDrRate(widget.chatId,widget.expertPresenter, context,widget.fromMainExpert,widget.fromActiveClini);
                                                  },
