...
class CalenderEn extends StatefulWidget {
  final CalenderPresenter? calenderPresenter;
  final isOfflineMode;
  final ExpertPresenter? expertPresenter;

  CalenderEn({Key? key,this.calenderPresenter,this.isOfflineMode,this.expertPresenter}):super(key:key);
  @override
  State<StatefulWidget> createState() => CalenderEnState();
...
class CalenderEnState extends State<CalenderEn> with TickerProviderStateMixin implements CalenderView {
...
//  }
  ...
  List<String> weekDay = ['دو','سه','چهار','پنج','جمعه','شنبه','یک'];
                                    ...
                                    child: InkWell(
                                        ...
                                        onTap: (){
                                          if(snapshotAdv.data!.typeLink == 1 || snapshotAdv.data!.typeLink == 2){
                                            AnalyticsHelper().log(AnalyticsEvents.CalendarMiladiPg_AdvBanner_Banner_Clk);
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        GestureDetector(
                                          onTap: (){
                                            AnalyticsHelper().log(AnalyticsEvents.CalendarMiladiPg_LastMonth_Btn_Clk);
                                        ...
                                        GestureDetector(
                                          onTap:(){
                                            AnalyticsHelper().log(AnalyticsEvents.CalendarMiladiPg_NextMonth_Btn_Clk);
                                                       ...
                                                       itemBuilder: (context, index1) {
                                                         return  Opacity(
                                                             ...
                                                             child:  GestureDetector(
                                                               onTap: () {
                                                                 AnalyticsHelper().log(
                                                                     AnalyticsEvents.CalendarMiladiPg_ItemDate_Item_Clk,
                                                                     parameters: {
                                                               ...
                                                               child:  Stack(
                                                                 ...
                                                                 children: <Widget>[
                                                                   Container(
                                                                       ...
                                                                       Center(
                                                                         child: Text(
                                                                           // Jalali.fromDateTime(snapshot.data[index].cells[index1].getDateTime()).day.toString(),
                                                                           snapshot.data![index].cells[index1].getDateTime().day.toString(),
                                                        ...
                                                        child:  GestureDetector(
                                                            onTap: ()async{
                                                              ...
                                                              if(snapshotIsAlarm.data!){
                                                                AnalyticsHelper().log(AnalyticsEvents.CalendarMiladiPg_Notes_Btn_Clk);
                                                              }else{
                                                                AnalyticsHelper().log(AnalyticsEvents.CalendarMiladiPg_RecordNotes_Btn_Clk);
                                                              }
...
//                 StreamBuilder(
//                  stream: widget.calenderPresenter.isShowAddNoteDialogObserve,
...
//                          onPressCancel: widget.calenderPresenter.onPressCancelAddNoteDialog,
//                          calenderPresenter: widget.calenderPresenter,
//                          mode: widget.calenderPresenter.mode,
//                        );
//                      }else{
//                        return  Container();
//                      }
