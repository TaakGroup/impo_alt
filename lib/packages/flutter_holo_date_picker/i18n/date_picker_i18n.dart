...
part 'strings_af.dart';

part 'strings_en_fa.dart';
...
const Map<DateTimePickerLocale, _StringsI18n> datePickerI18n = {
  ...
  DateTimePickerLocale.fa: _StringsFa(),
  DateTimePickerLocale.af: _StringsAf(),
  DateTimePickerLocale.en_fa: _StringsEnFa(),
};
